...
$shuffle.textContent = '덱 섞기'
//$sort.textContent = 'Deck Sort'
//$bysuit.textContent = '선정렬'
$fan.textContent = '부채꼴 정렬'
$poker.textContent = '카드 세장 뽑기'
$flip.textContent = '카드 뒤집기'
